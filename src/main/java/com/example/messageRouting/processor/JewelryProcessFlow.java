...
public class JewelryProcessFlow extends RouteBuilder{
	...
	public void jewelryProcessFlow(Exchange exchange) {
		try {
			...
			log.error("Error occured while mapping Json in jewelryProcessFlow: ", e);
		} catch (JsonProcessingException e) {
			log.error("Error occured while processing Json in jewelryProcessFlow: ",e);
		} catch (Exception e) {
            log.error("Unexpected error in jewelryProcessFlow: ", e);
        }
	}

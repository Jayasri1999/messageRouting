...
public class KidsToysProcessFlow extends RouteBuilder{
	...
	public void kidsToysProcessFlow(Exchange exchange) {
		try {
			...
			log.error("Error occured while mapping Json in kidsToysProcessFlow: ", e);
		} catch (JsonProcessingException e) {
			log.error("Error occured while processing Json in kidsToysProcessFlow: ",e);
		} catch (Exception e) {
            log.error("Unexpected error in kidsToysProcessFlow: ", e);
        }
	}
